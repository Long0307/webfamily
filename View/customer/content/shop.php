						...
						if(isset($_GET['idlsp'])){
							...
							if(isset($_GET['trang'])){
								if($_GET['trang'] < 2){
									...
									echo '<a class="page-link" href="shop/'.($_GET['idlsp'])."/".vn_to_str($value['TenDanhMuc']).".html".".html".'&trang='.($_GET['trang']-1).'">Prev</a>';
								}

								echo '<a class="page-link" href="shop/'.($_GET['idlsp']).'&trang=1">Trand đầu</a>';
								...
								if(($_GET['trang'] - 3) > 0){
									for($b = $_GET['trang'] - 3; $b <= $_GET['trang'] + 3;$b++){
										...
										if(($b > $b - 3) && ($b < $b + 3)){
											...
											echo '<a class="page-link" href="shop/'.($_GET['idlsp'])."/".vn_to_str($value['TenDanhMuc']).".html".'&trang='.$b.'">'.$b.'</a>';
										}
								...
								echo '<a class="page-link" href="shop/'.($_GET['idlsp'])."/".vn_to_str($value['TenDanhMuc']).".html".'&trang='.$a.'">Trang cuối</a>';

								if(isset($_GET['trang'])){
									if($_GET['trang'] < ($a - 2)){
										echo '<a class="page-link" href="shop/'.($_GET['idlsp'])."/".vn_to_str($value['TenDanhMuc']).".html".'&trang='.($_GET['trang']+1).'">Next</a>';
									}
								}
								...
								echo '<a class="page-link" href="shop/'.($_GET['idlsp'])."/".vn_to_str($value['TenDanhMuc']).".html".'&trang=2">Next</a>';
							}
							...
							if(isset($_GET['trang'])){
								...
								if(($_GET['trang'] - 3) > 0){
									for($b = $_GET['trang'] - 3; $b <= $_GET['trang'] + 3;$b++){
										...
										if(($b > $b - 3) && ($b < $b + 3)){
											...
											echo '<a class="page-link" href="shop&trang='.$b.'">'.$b.'</a>';
										}
								...
								echo '<a class="page-link" href="shop&trang='.$a.'">Trang cuối</a>';
								...
								echo '<a class="page-link" href="shop&trang=2">Next</a>';
							}
