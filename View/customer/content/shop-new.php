						...
						if(isset($_GET['idlsp'])){
							...
							if(isset($_GET['trang'])){
								if($_GET['trang'] < 2){
									...
									echo '<a class="page-link" href="shop/'.($_GET['idlsp']).'&trang='.($_GET['trang']-1).'">Prev</a>';
								}
								...
								if(($_GET['trang'] - 3) > 0){
									for($b = $_GET['trang'] - 3; $b <= $_GET['trang'] + 3;$b++){
										...
										if(($b > $b - 3) && ($b < $b + 3)){
											...
											echo '<a class="page-link" href="shop/'.($_GET['idlsp']).'&trang='.$b.'">'.$b.'</a>';
										}
								...
								echo '<a class="page-link" href="shop/'.($_GET['idlsp']).'&trang='.$a.'">Trang cuối</a>';

								if(isset($_GET['trang'])){
									if($_GET['trang'] < ($a - 2)){
										echo '<a class="page-link" href="shop/'.($_GET['idlsp']).'&trang='.($_GET['trang']+1).'">Next</a>';
									}
								}
								...
								echo '<a class="page-link" href="shop/'.($_GET['idlsp']).'&trang=2">Next</a>';
							}
