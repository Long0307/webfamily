                ...
                foreach($data['search'] as $value) {
                  ...
                  ?>
                   <tr id="load_<?php echo $value['id']; ?>">
                      ...
                      <td>
                        <img src="../../public/avatar_customer/<?php echo $value['avatar']; ?>"  width="90px" alt="">     
                      </td>
                      <td><?php echo $value['email']; ?></td>
                      <td><?php echo $value['phone']; ?></td>
                      <td>
                        <a href="../../admin/customer/info/<?php echo $value['id']; ?>/<?php echo vn_to_str($value['name']).".html"; ?>" class="btn btn-primary" style="margin-left: 10px;">Chi tiết</a>
            ...
            <script>
                function check(id){
                    ...
                    swalWithBootstrapButtons.fire({ 
                      ...
                      if (result.value) {
                        $.get('index.php?controller=customer&action=delete&id='+id, function(data) {
                          if(data){
            ...
            <div class="pagination pagination-style-three m-t-20"> 
              ...
              if(isset($_GET['trang'])){
                if($_GET['trang'] < 2){
                  ...
                  echo '<a class="page-link" href="../../admin/customer&page='.($_GET['trang']-1).'">Prev</a>';
                }

                echo '<a class="page-link" href="../../admin/customer&page=1">Trand đầu</a>';
                ...
                if(($_GET['trang'] - 3) > 0){
                  for($b = $_GET['trang'] - 3; $b <= $_GET['trang'] + 3;$b++){
                    ...
                    if(($b > $b - 3) && ($b < $b + 3)){
                      ...
                      echo '<a class="page-link" href="../../admin/customer&page='.$b.'">'.$b.'</a>';
                    }
                ...
                echo '<a class="page-link" href="../../admin/customer&page='.$a.'">Trang cuối</a>';

                if(isset($_GET['trang'])){
                  if($_GET['trang'] < ($a - 2)){
                    echo '<a class="page-link" href="../../admin/customer&page='.($_GET['trang']+1).'">Next</a>';
                  }
                }
                ...
                echo '<a class="page-link" href="../../admin/customer&page=2">Next</a>';
              }
              ?>
            </div>
